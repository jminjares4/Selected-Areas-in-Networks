...
data = pd.read_csv('JesusMinjaresData.csv')
...
data_frame_graph = pd.DataFrame.hist(data, column='BYTES',grid=False,bins=400,range=[min_val,max_val],label='Bytes', xlabelsize=10, ylabelsize=10)
