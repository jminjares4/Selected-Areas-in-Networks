...
sudo ovs-ofctl add-flow s1 dl_dst=01:01:01:01:01:01,actions=output:3
...
sudo ovs-ofctl add-flow s2 dl_dst=02:02:02:02:02:02,actions=output:3

# Switch 3
sudo ovs-ofctl add-flow s3 arp,sactions=normal
